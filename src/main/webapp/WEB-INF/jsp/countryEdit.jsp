			...
			<div class="row">
				<div class="col-sm-10 col-sm-offset-1">
					<div class="form-actions">
						...
						<input type="button" class="btn btn-primary" data-toggle="modal" data-target="#confirmSave" onclick="submitForm()"
							value="Сохранить" /> 
							<input type="button"
							class="btn btn-primary" data-toggle="modal" data-target="#confirmSave" onclick="submitForm()"
							value="Скопировать" /> 
							<input type="button"
							class="cancelbtn" data-toggle="modal" data-target="#confirmSave" onclick="submitForm()"
							value="Отмена" />

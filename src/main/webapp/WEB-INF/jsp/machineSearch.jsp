...
<html lang="ru">
	<head>
	    <title>Таблица подъемно-транспортного оборудования</title>
		   ...
		   <!----- Begin page content ------>
		 <div class="container"> 
				<form:form id="machine_search_form" class="form-horizontal mini" style="margin-bottom: 0px;" action="machineSearch" commandName="machineSearchCommand" method="post" accept-charset="UTF-8">
		   <div class="row">
				...
				<!--Sidebar content-->
					<div class="col-sm-4">
					 ...
					 <!--  Операции с данными в таблице -->
				                    <div class="col-sm-12">
		                            <a href="<c:url value="machineEdit"/>" class="btn btn-primary pull-right" title="Ввод нового">Добавить</a><span class="pull-right">&nbsp;</span>
			                    ...
			                    <table id="machine_table" class="table table-striped table-bordered">
			                          <thead>
			                              <tr>
				                              ...
				                              <th class="hidden-sm hidden-xs hidden-md nowrap">Номенклатурный №</th>
			                          ...
			                          <tbody>
			                          	...
			                          	<c:if test="${machine.archived != 'Y'}" >
				                            <tr>
				                              ...
				                              <td class="hidden-sm hidden-xs hidden-md nowrap">
					                          ...
					                          <a href="<c:url value="machineEdit?machineId=${machine.machineId}&copy=true"/>">&nbsp;<span class="glyphicon glyphicon-fullscreen" title="Копировать"></span>&nbsp;</a>
					                         		<a href="<c:url value="machineEdit?machineId=${machine.machineId}"/>">
				                              	<c:if test="${system.localConfig}" >
				                              		<%-- <span class="alert-danger">
				                              ...
				                              <td class="hidden-sm hidden-xs hidden-md nowrap"><c:out value="${machine.stevidor.fullName}"/></td>
				                              <td class="hidden-sm hidden-xs nowrap"><c:out value="${machine.details}"/></td>
				                              <td class="hide"><c:out value="${machine.machineModel.manufacturer.name}"/></td>
				                              <td class="hide"><c:out value="${machine.releaseYear}"/></td>
				                              <td class="hide"><spring:eval expression="machine.startDate" /></td>
				                              ...
				                              <td class="hide"><c:out value="${machine.stevidor.port.name}"/></td>
				                              <td class="hide"><c:out value="${machine.stevidor.port.country.nameRus}"/></td>
				                              <td class="hidden-sm hidden-xs hidden-md nowrap"></td>
				                              <td class="hide"></td>
				                              <td class="hidden-sm hidden-xs hidden-md nowrap"><c:out value="${machine.note}"/></td>
